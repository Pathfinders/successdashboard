...
class Survey extends Component {
    ...
    render(){
        ...
        return (<div className="innertube">
            ...
            <Questions userid={this.state.userdata.userid} projectid={this.state.projectid} projectData={this.state.projectData} groupid={this.state.groupid} month={this.state.month} year={this.state.year}/>
        </div>);
    }
}
